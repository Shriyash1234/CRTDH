    ...
    <section className='reserach-page'>
        <Header color={'black'}/>
         <div className='research'>
            ...
            <p className='about-us-text' style={{margin:"0px 5%",textAlign:"justify"}}>DSIR has extended funding support to 18 CRTDHs from FY 2014-1015. These CRTDHs are being established in Electronics/Renewable Energy, Affordable Health, Environmental Interventions, Low-cost Machining and New Materials/Chemical Processes across 14 states. These CRTDHs are located at IITs, NITs, CSIR Labs, and Universities based on the geographical location and their expertise to create a conducive ecosystem for MSME clusters around them. These hubs facilitate MSMEs to undertake new and improved product and process development and skill enhancement activities. The collaborating institutions extend hands-on training, skill development, and research facilities to the MSMEs. Over the years, the 18 CRTDHs supported by DSIR have made an excellent impact by developing an infrastructure for R&D, sensitizing and engaging a large number of MSMEs/Startups for R&D activities, developing /transforming technologies, generating intellectual properties etc. Creating these CRTDHs enhanced productivity, increased the innovative skills of the MSMEs/Startups, made MSMEs globally competitive, and generated more employment.</p>
